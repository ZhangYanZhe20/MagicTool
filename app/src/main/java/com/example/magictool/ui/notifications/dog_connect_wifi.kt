...
import com.example.magictool.ui.WifiConfiguratorDog

class dog_connect_wifi : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dog_net, container, false)
    }
    ...
    private fun getConfigurator(): WifiConfiguratorDog {
        val host = etHost.text.toString().trim().ifEmpty { "192.168.55.200" }
        return WifiConfiguratorDog(host, sshUsername, sshPassword)
    }
