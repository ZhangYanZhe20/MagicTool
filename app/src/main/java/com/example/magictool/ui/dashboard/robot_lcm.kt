...
import com.example.magictool.databinding.RobotLcmBinding
...
class robot_lcm : Fragment() {

    private var _binding: RobotLcmBinding? = null
    private val binding get() = _binding!!

    private val sshHost = "192.168.54.110"
    private val sshUser = "eame"
    private val sshPwd = "123"
    private val remoteLogDir = "/opt/log/"
    ...
    override fun onCreateView(
        ...
        _binding = RobotLcmBinding.inflate(inflater, container, false)
    ...
    private fun genRemoteFileName(): String {
        ...
        return "lcm_robot_${sdf.format(Date())}"
    }
